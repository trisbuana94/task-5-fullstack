        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 mb-4">
                    ...
                    />
                    <p>
                        Official Smartphone Store Terpercaya di Indonesia. Jual
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <p>
                        ...
                        <br />
                        Senin - Minggu ( 09.00 s/d 18.00 )
                    </p>
                    <p>
                        <i class="fa fa-map-marker"></i> Permata Buana, RT/RW :
                        002/004, Kecamatan Cengkareng, Jakarta Barat, DKI
                        Jakarta, 14041
                    </p>
                </div>
            </div>
            <div class="row text-center mt-3 pb-3">
                <div class="col-md-12">
                    <hr />
                    © <strong>Sinyal Store</strong> 2023 • Hak Cipta Dilindungi
                </div>
            </div>
        </div>
    </footer>
